...
class BNO055(object):
   ...
   def _write_bytes(self, ptr_reg, data, ack=True):
      # Write a list of 8-bit values starting at the provided register address
      self.i2c_channel.write(self.i2c_channel.SDA, ptr_reg, data)

   def _write_byte(self, ptr_reg, value,ack=True):
      # Write an 8-bit value to the provided register address.
      self.i2c_channel.write(self.i2c_channel.SDA, ptr_reg, value)
